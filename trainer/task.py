...
def get_args():
  ...
  parser.add_argument(
    ...
    type=str,
    #required=True,
    default = './fashionmnist/train-images-idx3-ubyte.gz',
    help='Training file local or GCS')
  parser.add_argument(
    '--train-labels-file',
    type=str,
    #required=True,
    default = './fashionmnist/train-labels-idx1-ubyte.gz',
    help='Training labels file local or GCS')
  parser.add_argument(
    '--test-file',
    type=str,
    #required=True,
    default='./fashionmnist/t10k-images-idx3-ubyte.gz',
    help='Test file local or GCS')
  parser.add_argument(
    '--test-labels-file',
    type=str,
    #required=True,
    default='./fashionmnist/t10k-labels-idx1-ubyte.gz',
    help='Test file local or GCS')
  parser.add_argument(
    '--num-epochs',
    type=float,
...
def train_and_evaluate(hparams):
  ...
  # Create estimator.
  estimator=model.keras_estimator(train_images, train_labels, mode=tf.estimator.ModeKeys.TRAIN)
