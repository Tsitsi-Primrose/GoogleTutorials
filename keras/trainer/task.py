...
def get_args():
  ...
  parser.add_argument(
    ...
    type=str,
    #required=True,
    default='gs://fashion_cnn/train-images-idx3-ubyte.gz',
    help='Training file local or GCS')
  parser.add_argument(
    '--train-labels-file',
    type=str,
    #required=True,
    default='gs://fashion_cnn/train-labels-idx1-ubyte.gz',
    help='Training labels file local or GCS')
  parser.add_argument(
    '--test-file',
    type=str,
    #required=True,
    default='gs://fashion_cnn/t10k-images-idx3-ubyte.gz',
    help='Test file local or GCS')
  parser.add_argument(
    '--test-labels-file',
    type=str,
    #required=True,
    default='gs://fashion_cnn/t10k-labels-idx1-ubyte.gz',
    help='Test file local or GCS')
  parser.add_argument(
    '--num-epochs',
    type=float,
